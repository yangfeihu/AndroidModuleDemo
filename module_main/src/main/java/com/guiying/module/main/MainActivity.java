 ...
 * <p>类说明</p>
 *
 * @author yangfeihu 2017/7/1 13:13
 * @version V1.2.0
 * @name MainActivity
 */
public class MainActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.movie_button).setOnClickListener(this);
    ...
    public void onClick(View view) {
        if (view.getId() == R.id.news_button) {
            ...
            ARouter.getInstance().build(Path.PAHT_NEWS).navigation();
        } else if (view.getId() == R.id.movie_button) {
            //跳转到GirlsActivity
