 ...
 * @name GirlsView
 */
public class MovieView extends FrameLayout implements MovieContract.View, SwipeRefreshLayout.OnRefreshListener, RecyclerArrayAdapter.OnLoadMoreListener {
    ...
    private void initView() {
        inflate(getContext(), R.layout.view_movie_content, this);
        ...
        mAdapter.setOnMyItemClickListener(new MovieAdapter.OnMyItemClickListener() {
            @Override
            public void onItemClick(int position, BaseViewHolder holder) {
             /*   Intent intent = new Intent(Utils.getActivity(MovieView.this), MovieActivity.class);
                ...
                Utils.getActivity(MovieView.this).startActivity(intent, options.toBundle());*/
            }
        });
    ...
    @Override
    public void refresh(List<Movie> data) {
        mData.clear();
        mData.addAll(data);
        mAdapter.clear();
    ...
    @Override
    public void load(List<Movie> data) {
        mData.addAll(data);
        mAdapter.addAll(data);
    }
